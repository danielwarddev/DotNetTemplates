---
name: spec-creation
description: Guidelines for creating feature specification documents for this .NET project. Use this skill when the user asks you to create a new spec or flesh out an existing one, write a user story, or document feature requirements.
---
...
- **Naming**: `SPEC-XX-Feature-Name.md` (e.g., `SPEC-01-Initial-Setup.md`)
...
- Use action verbs (User can..., System detects..., Service returns...)
